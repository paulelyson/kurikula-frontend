...
export class UserService {
  ...
  getUsers() {
    return this.http
      .get<ApiResponse<User[]>>(environment.api_url + '/api/user')
      .pipe(catchError(this.exceptionService.handleError.bind(this.exceptionService)));
  }

  createUser(userData: Partial<User>) {
    return this.http.post<ApiResponse<User>>(environment.api_url + '/api/user', userData).pipe(catchError(this.exceptionService.handleError));
  }
